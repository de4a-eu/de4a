...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (1, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 1);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (2, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 2);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (3, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 3);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (4, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 4);

INSERT INTO Source (id, canonicalEvidenceTypeId, atulevel, countryCode, numProvisions, organisation) VALUES (5, 'HigherEducationDiploma', 'nuts0', 'ES', null, null);
INSERT INTO ProvisionItem (id, atuCode, AtuLatinName, dataOwnerId, DataOwnerPrefLabel, id_source) VALUES (5, 'ES', 'España', 'iso6523-actorid-upis::9999:E05025101', 'MINISTERIO DE UNIVERSIDADES', 5);
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (5, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 5);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (6, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 6);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (7, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 7);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (8, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 8);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (9, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 9);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (10, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 10);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (11, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 11);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (12, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 12);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (13, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 13);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (14, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 14);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (15, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 15);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (16, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 16);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (17, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 17);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (18, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 18);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (19, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 19);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (20, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 20);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (21, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 21);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (22, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 22);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (23, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 23);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (24, 'ip', 'https://pre-smp-dr-de4a.redsara.es/de4a-mock-connector/preview/index?requestId={requestId}?backUrl={backUrl}' , 24);
