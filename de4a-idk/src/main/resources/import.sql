...
INSERT INTO ProvisionItem (id, atuCode, AtuLatinName, dataOwnerId, DataOwnerPrefLabel, id_source) VALUES (1, 'AT', 'ÖSTERREICH', 'iso6523-actorid-upis::9991:at000000271', 'BUNDESMINISTERIUM FUER DIGITALISIERUNG UND WIRTSCHAFTSSTANDORT (BMDW)', 1);
...
INSERT INTO ProvisionItem (id, atuCode, AtuLatinName, dataOwnerId, DataOwnerPrefLabel, id_source) VALUES (3, 'SE', 'SVERIGE', 'iso6523-actorid-upis::9920:se000000013', 'Rijksdienst voor Ondernemend Nederland (BVE)', 3);
...
INSERT INTO ProvisionItem (id, atuCode, AtuLatinName, dataOwnerId, DataOwnerPrefLabel, id_source) VALUES (4, 'RO', 'ROMÂNIA', 'iso6523-actorid-upis::9991:ro000000006', 'OFICIUL NATIONAL AL REGISTRULUI COMERTULUI (ONRC)', 4);
...
INSERT INTO ProvisionItem (id, atuCode, AtuLatinName, dataOwnerId, DataOwnerPrefLabel, id_source) VALUES (6, 'SI', 'SLOVENIJA', 'iso6523-actorid-upis::9920:si000000016', 'MINISTRSTVO ZA IZOBRAZEVANJE, ZNANOST IN SPORT (MIZS)', 6);
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (6, 'usip', 'https://b51-preview.pprod.medius.si/de4a/preview', 6);
...
INSERT INTO ProvisionItem (id, atuCode, AtuLatinName, dataOwnerId, DataOwnerPrefLabel, id_source) VALUES (7, 'PT', 'PORTUGAL', 'iso6523-actorid-upis::9991:pt000000026', '(AMA IP) Agencia para a Modernizacao Administrativa IP (Administration Modernization Agency)', 7);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (9, 'usip', null, 9);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (10, 'usip', 'https://b51-preview.pprod.medius.si/de4a/preview', 10);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (11, 'usip', null, 11);
...
INSERT INTO ProvisionItem (id, atuCode, AtuLatinName, dataOwnerId, DataOwnerPrefLabel, id_source) VALUES (14, 'RO', 'ROMÂNIA', 'iso6523-actorid-upis::9991:ro000000005', 'MINISTERUL AFACERILOR INTERNE (MoAI)', 14);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (19, 'usip', 'https://b51-preview.pprod.medius.si/de4a/preview', 19);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (23, 'usip', 'https://b51-preview.pprod.medius.si/de4a/preview', 23);
...
INSERT INTO Provision (id, provisionType, redirectURL, id_provisionItem) VALUES (25, 'usip', 'https://de4a.redsara.es/de4a-pid-owner/welcome', 25);
