...
import eu.toop.as4.handler.IncomingAS4PKHandler;
...
import eu.toop.service.ApplicationContextProvider;
 ...
 */
@IsSPIImplementation 
public class AS4MessageProcessorSPIPeique extends AS4MessageProcessorSPI implements IAS4ServletMessageProcessorSPI 
{
  public static final String ACTION_FAILURE = "Failure";
  private static final Logger LOGGER = LoggerFactory.getLogger (AS4MessageProcessorSPIPeique.class);
