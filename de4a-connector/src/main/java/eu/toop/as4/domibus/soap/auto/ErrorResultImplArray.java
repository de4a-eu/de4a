...
/**
 * <p>Clase Java para errorResultImplArray complex type.
 * 
...
@XmlType(name = "errorResultImplArray", namespace = "http://org.ecodex.backend/1_1/", propOrder = {
    "item"
})
public class ErrorResultImplArray {
    ...
    public List<ErrorResultImpl> getItem() {
        if (item == null) {
            item = new ArrayList<ErrorResultImpl>();
        }
        return this.item;
    }
