package eu.toop.as4.client.regrep;
...
public class CletusLevelTransformer {
	...
	//private static final String XPATH_QUERYSLOT="//*[local-name()='Query']/*[local-name()='Slot'][contains(@name,'ConceptRequestList')]/*[local-name()='SlotValue']/*[local-name()='Element']";
	//Query/Slot	[contains(@name,'ConceptRequestList')]/SlotValue/Element
...
//			   
//			    if(request) {
//			    	docFinal.adoptNode(canonical);
//			    	Node query=DOMUtils.getNodeFromXpath(XPATH_QUERYSLOT, docFinal.getDocumentElement());
//				    query.appendChild(canonical);
//			    } 
