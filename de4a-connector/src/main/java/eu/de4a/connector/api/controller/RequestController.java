...
public class RequestController implements RequestAPI {
    ...
    @Override
    public ResponseEntity<byte[]> requestEvidenceUSI(@Valid InputStream request) {
        log.debug("Request to API /usi/ received");
        
        var marshaller = DE4ACoreMarshaller.drRequestTransferEvidenceUSIMarshaller();
        
        // Unmarshalling and schema validation
        RequestExtractMultiEvidenceUSIType requestObj = (RequestExtractMultiEvidenceUSIType)
        ...
        AS4MessageDTO messageDTO = new AS4MessageDTO(requestObj.getDataEvaluator().getAgentUrn(), 
        ...
        boolean isSent = this.apiManager.processIncomingMessage(requestObj, messageDTO, 
    ...
    @PostMapping(value = "/im/", produces = MediaType.APPLICATION_XML_VALUE, 
            consumes = MediaType.APPLICATION_XML_VALUE)
    @Override
    public ResponseEntity<byte[]> requestEvidenceIM(@Valid InputStream request) {
        log.debug("Request to API /im/ received");
        
        var marshaller = DE4ACoreMarshaller.drRequestTransferEvidenceIMMarshaller();
        
        // Unmarshalling and schema validation
        RequestExtractMultiEvidenceIMType requestObj = (RequestExtractMultiEvidenceIMType)
                APIRestUtils.conversionBytesWithCatching(marshaller,request, false, true, 
                        new ConnectorException().withModule(ExternalModuleError.CONNECTOR_DR));
    ...
    @PostMapping(value = "/lu/", produces = MediaType.APPLICATION_XML_VALUE, 
            consumes = MediaType.APPLICATION_XML_VALUE)
    @Override
    public ResponseEntity<byte[]> requestEvidenceLU(@Valid InputStream request) {
        log.debug("Request to API /lu/ received");
        
        var marshaller = DE4ACoreMarshaller.drRequestTransferEvidenceIMMarshaller();
        
        // Unmarshalling and schema validation
        RequestExtractMultiEvidenceLUType requestObj = (RequestExtractMultiEvidenceLUType)
                APIRestUtils.conversionBytesWithCatching(marshaller,request, false, true, 
                        new ConnectorException().withModule(ExternalModuleError.CONNECTOR_DR));
    ...
    @PostMapping(value = "/subscription/", produces = MediaType.APPLICATION_XML_VALUE, 
            consumes = MediaType.APPLICATION_XML_VALUE)
    @Override
    public ResponseEntity<byte[]> requestEventSubscription(@Valid InputStream request) {
        log.debug("Request to API /subscription/ received");
        
        var marshaller = DE4ACoreMarshaller.drRequestEventSubscriptionMarshaller();
        
        // Unmarshalling and schema validation
        RequestEventSubscriptionType requestObj = (RequestEventSubscriptionType)
                APIRestUtils.conversionBytesWithCatching(marshaller,request, false, true, 
                        new ConnectorException().withModule(ExternalModuleError.CONNECTOR_DR));
