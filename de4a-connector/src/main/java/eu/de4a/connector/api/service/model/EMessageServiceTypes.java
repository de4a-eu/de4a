...
/**
 * Enum for controlling correspondences between message types (root XML element name) and DE/DO
 * addresses properties {@link application.yml}. If something changes on {@link eu.de4a.iem.core} it
 * forces to update this class and keep it up to date
 *
 */
