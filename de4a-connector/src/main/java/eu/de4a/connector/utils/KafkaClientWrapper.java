...
public class KafkaClientWrapper {
    ...
    public static void sendError(final EFamilyErrorType errorType, EExternalModule module, final Object...params) {
    ...
    private static void _sendError(final EFamilyErrorType errorType, final EExternalModule module, final EErrorLevel level, Object...params) {
    	ArrayList<Object> listParams = new ArrayList<Object>(Arrays.asList(params));
    	var code = module.getID() + ELogMessageLevel.ERROR.getCode() + errorType.getID();
