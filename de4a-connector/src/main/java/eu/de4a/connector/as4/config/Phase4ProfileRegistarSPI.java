package eu.de4a.connector.as4.config;
...
@IsSPIImplementation
public class Phase4ProfileRegistarSPI implements IAS4ProfileRegistrarSPI
{
  ...
  public void registerAS4Profile (@Nonnull final IAS4ProfileRegistrar aRegistrar)
  {
    ...
    final IAS4Profile aProfile = new AS4Profile (AS4_PROFILE_ID,
                                                 ...
                                                 (i, r, a) -> DE4APMode.createDCNGMode (i, r, a, i + "-" + r, true),
                                                 aPModeIDProvider,
                                                 false);
